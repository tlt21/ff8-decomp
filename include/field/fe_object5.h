...
extern s32  func_800B0924(Eline *e);                /* op131 HOLD */
...
extern s32  func_800B0D94(Eline *e);                /* op070 PGETINFO */
extern s32  func_800B0E68(Eline *e);
extern s32  func_800B0EBC(Eline *e);                /* op??? JUNCTION */
extern s32  func_800B1034(Eline *e);
extern s32  func_800B10F8(Eline *e);
extern s32  func_800B11BC(Eline *e);                /* op12D ACTORMODE */
extern s32  func_800B12A4(Eline *e);                /* op0A3 MOVIEREADY */
extern s32  func_800B13EC(Eline *e);                /* op04F MOVIE */
extern void func_800B14C8(void);                    /* MOVIE postlude halve */
extern s32  func_800B158C(u8 *a0);                  /* op050 MOVIESYNC */
extern s32  func_800B15BC(Eline *e);                /* op056 SPUREADY */
extern s32  opHandler_SPUSYNC(Eline *e);            /* 0x800B16B0 op164 */
extern s32  func_800B1730(u8 *a0);
extern s32  func_800B1738(Eline *e);                /* op0A1 SETVIBRATE */
...
extern s32  func_800B18A4(Eline *e);                /* op0B5 MUSICLOAD */
...
extern s32  func_800B2248(Eline *e);                /* op0BD EFFECTLOAD */
